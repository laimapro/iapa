...
<?php  if($funcao == 0 || $funcao == 2 || $funcao == 3){ ?><button onclick="window.location.href='cria_categoria.php'" accesskey="3">Não encontrou a categoria pretendida, Crie-a aqui</button> <br><?php } ?>
