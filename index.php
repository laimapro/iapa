...
<div class="container px-4 py-5">
    <div class="p-5 rounded-3 bg-white border shadow-lg text-center">
        ...
        <div class=" py-3 text-start col-lg-8 mx-auto my-4 my-4 text-body-secondary">
            ...
            <p>Será um processo tranquilo. Eu lhe ajudarei em todas as etapas do processo, garantindo que você aproveite ao máximo todos os recursos que o <strong>IAPA</strong> tem a oferecer.</p>
        </div>
        ...
        <nav class="mt-5 flex-wrap justify-content-center d-inline-flex gap-2 mb-5">
            ...
            <ul class="d-flex align-items-center flex-wrap flex-md-row flex-column mb-0 list-unstyled">
                <li class="px-3"><button class="btn px-4 rounded-pill btn-link contrast-btn" onclick="toggleContrast()" title="Alterar a aparência desta página" accesskey="4"><i class="bi bi-circle-half"></i></button></li>
