...
<div class="container px-4 py-5">
    ...
    <ul class="my-5 list-group list-group-flush">
        <?php if ($funcao == 2 || $funcao == 3  || $funcao == 0) {?><li class="px-0 list-group-item"><a class="text-decoration-none d-block" href="avaliacao.php" accesskey="1" title="Alt + 1: Permite iniciar a avaliação de uma PA">Avaliar uma Produção Acadêmica</a></li><?php }?>
        <?php if ($funcao == 1 || $funcao == 3  || $funcao == 0) { ?><li class="px-0 list-group-item"><a class="text-decoration-none d-block" href="pagina_categoria.php" title="Alt + 2: Permite criar um novo IAPA" accesskey="2">Criar um Instrumento de Avaliação de Produção Acadêmica</a></li>
        <?php }?>
        <li class="px-0 list-group-item"><a class="text-decoration-none d-block"  href="upload.php" accesskey="3" title="Alt + 3: Cadastra produções acadêmicas e acessa pareceres produzidos">Banco de produções e pareceres</a></li>
            <li class="pt-5 px-0 list-group-item"><a href="sair.php" title="Alt + 6: Será necessário fazer login para entrar no IAPA novamente" accesskey="5"><i class="bi bi-arrow-left me-1"></i>Voltar para a página inicial</a></li>
        <?php  if ($funcao == 3 || $funcao == 0) { ?><li class="px-0 list-group-item"><a class="text-decoration-none d-block" href="admin/index.php" accesskey="6" title="Alt + 6: Área administrativa">Área administrativa</a></li><?php } ?>
